...
The scope of this assignment is to implement the RTL (Register Transfer Level) and TLM () code to implement the matrix multiplication.

3x3 matrices will be used in this case
