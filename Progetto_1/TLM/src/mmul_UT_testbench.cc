...
void mmul_UT_testbench::run()
{
  ...
  cout << "Computing matrix multiplication..." << endl;
  ...
  cout<< "Simulation took:" << time_spent << " seconds. \n" ;
  sc_stop();
}
...
mmul_UT_testbench::mmul_UT_testbench(sc_module_name name): sc_module(name)
{
